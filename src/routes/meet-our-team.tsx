...
export const Route = createFileRoute("/meet-our-team")({
  head: () => ({
    meta: [
      { title: "Meet Our Team — SOP Support" },
      { name: "description", content: "The people behind SOP Support — engineers, designers and growth specialists for home care agencies." },
    ],
  }),
