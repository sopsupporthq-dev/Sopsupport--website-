...
function RootComponent() {
  return (
    <>
      {/* Renders each route's head() config (title, meta, OG tags, canonical
          link, JSON-LD) into the real document <head>. Without this, every
          route's `head` option is declared but never actually applied. */}
      <HeadContent />
      <BuildWatermark />
      <PageTransition />
