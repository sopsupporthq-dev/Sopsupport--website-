...
export const Route = createFileRoute("/playbook/revenue-cycle-billing")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/playbook/revenue-cycle-billing" },
    ],
    links: [{ rel: "canonical", href: "/playbook/revenue-cycle-billing" }],
  }),
