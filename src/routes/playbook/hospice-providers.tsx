...
export const Route = createFileRoute("/industries/hospice-providers")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/industries/hospice-providers" },
    ],
    links: [{ rel: "canonical", href: "/industries/hospice-providers" }],
  }),
