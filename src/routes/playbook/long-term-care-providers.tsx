...
export const Route = createFileRoute("/playbook/long-term-care-providers")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/playbook/long-term-care-providers" },
    ],
    links: [{ rel: "canonical", href: "/playbook/long-term-care-providers" }],
  }),
