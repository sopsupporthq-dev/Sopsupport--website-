...
export const Route = createFileRoute("/playbook/senior-care-companies")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "/playbook/senior-care-companies" },
    ],
    links: [{ rel: "canonical", href: "/playbook/senior-care-companies" }],
  }),
