...
export function Footer() {
  return (
    <footer
      className="relative pt-16 pb-8 z-10"
      style={{ background: "linear-gradient(to bottom, rgba(0,0,0,0.92) 0%, #000 40%)" }}
      data-testid="footer"
    >
      <div className="max-w-[1600px] mx-auto px-6 xl:px-12 relative z-10">
        ...
        >
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="font-bold text-lg text-white">SOP Support</span>
            </div>
            <p className="text-xs text-white/40 uppercase tracking-widest mb-4">
              Websites & Growth Systems For Care Agencies
            </p>
            <p className="text-sm text-white/60 leading-relaxed">
              SOP Support helps home health agencies, hospice providers, and home care
              companies build modern websites, referral systems, SEO foundations and
        ...
        <div className="pt-6 border-t border-white/10 flex flex-col lg:flex-row items-center justify-between gap-4">
          <p className="text-xs text-white/35">© 2026 SOP Support. All rights reserved.</p>
