        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg lg:text-xl text-white/70 mb-10 leading-relaxed max-w-xl" data-testid="text-hero-subheadline">
              We help care agencies replace outdated websites with modern digital systems designed to build trust, improve local visibility, capture referrals, and support long-term growth.
            </p>
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: "Referral System", status: "Optimized", color: "bg-emerald-400", text: "text-emerald-300", pulse: false },
                  { label: "Website Support", status: "Active", color: "bg-teal-400", text: "text-teal-300", pulse: true },
                ].map((row, i) => (
                  <motion.div
                    key={row.label}
