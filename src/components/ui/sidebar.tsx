  ...
  (
    ...
    const setOpen = React.useCallback(
      (value: boolean | ((value: boolean) => boolean)) => {
        ...
        // SameSite=Lax + Secure are standard hardening for any cookie this
        // app sets — prevents it being sent on cross-site requests and (on
        // the https:// Cloudflare Pages deployment) blocks it from ever
        // being transmitted over plain http.
